...
export default async function ReservationsPage() {
  ...
  return (
    <main className="dashboard-page">
      <nav className="dashboard-nav"><Link className="brand" href="/"><span className="brand-mark" /> La Villa</Link><div><Link href="/compte">Mon profil</Link><Link href="/appartements">Appartements</Link><SessionControls isAuthenticated /></div></nav>
