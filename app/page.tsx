...
export default async function HomePage() {
  ...
  return (
    <main className="site-main">
      ...
      <footer className="footer"><div className="shell footer-inner"><span>© 2026 La Villa</span><span>Valencia · Méditerranée</span><div className="footer-links">{!isAdmin ? <Link href="/compte">Espace client</Link> : null}<Link href="/admin">Espace administration</Link></div></div></footer>
    </main>
  );
}
