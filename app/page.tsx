...
export default async function HomePage() {
  ...
  return (
    <main className="site-main">
      ...
      <section className="story-band" id="histoire"><div className="section shell story-grid"><div><p className="eyebrow">L&apos;esprit La Villa Appart</p><h2>Moins comme un hôtel. Plus comme chez vous.</h2><p>Des lieux pensés pour ralentir, recevoir et vivre pleinement. Une atmosphère chaleureuse, des quartiers vivants, et une expérience pensée pour mieux séjourner.</p><Link className="story-link" href="/appartements">Découvrir les adresses <span>↗</span></Link></div><div className="story-stat"><strong>24h</strong><span>pour vous répondre après votre demande de séjour</span></div></div></section>
